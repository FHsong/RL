...
class Policy(keras.Model):
    ...
    def __init__(self):
        ...
        self.fc2 = layers.Dense(2, kernel_initializer='he_normal', activation='softmax')
        # 网络优化器
...
def main():
    ...
    for n_episode in range(400):
        ...
        if n_episode%print_interval==0 and n_episode!=0:
            ...
            print(f"# of episode :{n_episode}, avg score : {score/print_interval}")
            score = 0.0
    env.close() # 关闭环境
